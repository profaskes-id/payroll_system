...
<div class="expenses-detail-form ">
    ...
    <div class="table-container">
        <div class="row">
            ...
            <div class="col-md-3">
                <?= $form->field($headerEx, 'tanggal')->textInput(['value' => Yii::$app->request->get('tanggal') ?? '', 'type' => 'date', 'readonly' => $model->isNewRecord ? false : true,])->label('Tanggal Transaksi') ?>
            </div>
        </div>
        <br>
            ...
            <table class="table table-bordered">
                ...
                <?php foreach ($dataHEader as $data) : ?>
                    ...
                    <tr>
                        <td>
                            <p class="mb-0">
                                <?= $data['id_expense_header'] ?>
                            </p>
                            <p>
                                <?= $tanggal->getIndonesiaFormatTanggal($data['tanggal']) ?>
                            </p>
                        </td>
