...
<!-- <div class="   mb-6 min-w-[350px] py-2 bg-[#252525] rounded-2xl  grid grid-cols-10 justify-items-center items-center ">
    ...
    <div class="col-span-2 ">
        <a href="/panel/home/absen-masuk" class="grid place-items-center">
...
<div class="relative z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <div class="flex items-center justify-center">
            <a href="/panel/home/absen-masuk" data-tooltip-target="tooltip-new" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-600 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
        ...
        <a href="/panel/home" data-tooltip-target="tooltip-settings" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
