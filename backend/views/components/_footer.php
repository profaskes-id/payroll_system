...
<div style="z-index: 999  !important;  background: #fff; " class=" z-[999] relative rounded-full -translate-y-4 h-16 w-[90%] md:w-[50%] -translate-x-1/2 bg-white border  bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600 ">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <div class="flex items-center justify-center">
            <a href="/panel/home/absen-masuk" data-tooltip-target="tooltip-new" class="relative inline-flex items-center justify-center w-12 h-12 font-medium -translate-y-5 bg-orange-400 rounded-full hover:bg-orange-500 group focus:ring-4 focus:ring-orange-300 focus:outline-none">
