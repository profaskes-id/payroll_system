      ...
      <div class="py-2" style="padding:10px 4px;">
        ...
        <div class="flex items-center justify-end space-x-4">
          <button
            ...
            <svg id="loading-terlambat" class="hidden w-4 h-4 mr-2 text-white animate-spin"
            ...
            <span id="text-submit-terlambat">Submit</span>
          </button>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('my-form-terlambat');
    const btn = document.getElementById('btn-submit-terlambat');
    const loader = document.getElementById('loading-terlambat');
    const text = document.getElementById('text-submit-terlambat');
