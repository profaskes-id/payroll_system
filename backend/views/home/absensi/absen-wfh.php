        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Anda Akan Melakukan Aksi Absen Masuk (WFH) ?</h3>
                    <button id="submitButtonWfh" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Ya, Yakin
                    </button>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Anda Akan Melakukan Aksi Absen Pulang (WFH) ?</h3>
                ...
                <div class="col-span-12  w-full">
                    ...
                    <?php if ($dataJam['today']) : ?>
                        ...
                        <?php else : ?>
                            ...
                            <?= $formAbsen->field($model, 'is_wfh')->hiddenInput(['value' => 1])->label(false) ?>
                                    ...
                                    <button class="all-none border border-[#EB5A2B]/50 p-4 rounded-full" data-modal-target="popup-modal" data-modal-toggle="popup-modal" type="button">
                                        <div class=" flex relative w-[225px] h-[225px] bg-gradient-to-r from-[#EB5A2B] to-[#EA792B] shadow-2xl shadow-[#EB5A2B] rounded-full  ">
                                            ...
                                            <p class=" flex justify-center items-center flex-col font-normal text-white absolute m-0 bottom-5 left-1/2 -translate-x-1/2">Absen Masuk
                                                <span class="text-center text-[10px] -mb-4">WFH</span>
                                            </p>
                                        </div>
                                    </button>
                                </div>
...
<script>
    ...
    let submitButtonWfh = document.getElementById('submitButtonWfh');
    ...
    submitButtonWfh.addEventListener('click', function() {
        navigator.geolocation.watchPosition(function(position) {
                document.querySelector('.latitude').value = position.coords.latitude.toFixed(10);
