        ...
        <div class="container block max-w-3xl py-8 mx-auto md:hidden">
            <div class="overflow-hidden bg-white shadow-md rounded-xl">
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <!-- Lembur Approval -->
                    <a href="/panel/tanggapan/lembur" class="block transition-all duration-200 group hover:bg-blue-50">
                    ...
                    <a href="/panel/tanggapan/wfh" class="block transition-all duration-200 group hover:bg-blue-50">
                        <div class="flex items-center justify-between p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="font-medium text-gray-800">WFH</h3>
                    ...
                    <!-- Cuti Approval -->
                    <a href="/panel/tanggapan/cuti" class="block transition-all duration-200 group hover:bg-blue-50">
                        <div class="flex items-center justify-between p-4">
                            <div class="flex items-center">
                                <div class="p-3 transition-colors duration-200 bg-blue-100 rounded-lg group-hover:bg-blue-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 16 16">
                    ...
                    <?php if ($deviasiAbsensi && $deviasiAbsensi['nilai_setting'] == 1) : ?>
                        ...
                        <a href="/panel/tanggapan/absensi" class="block transition-all duration-200 group hover:bg-blue-50">
                            <div class="flex items-center justify-between p-4">
                                <div class="flex items-center">
                                    <div class="p-3 transition-colors duration-200 bg-blue-100 rounded-lg group-hover:bg-blue-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 16 16">
