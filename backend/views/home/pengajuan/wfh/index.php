...
$this->title = 'Create Penajuan WFH';
$this->params['breadcrumbs'][] = ['label' => 'Penajuan WFH', 'url' => ['index']];
...
<div class="w-full mx-auto sm:px-6 lg:px-8 min-h-[90dvh] px-5">
    ...
    <div id="default-tab-content">
        ...
        <a href="/panel/pengajuan/wfh-create" class=" my-3 w-full flex items-center justify-center py-1 px-4  gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-400 text-white hover:bg-blue-400 focus:outline-none focus:bg-blue-400">+ Add New</a>
