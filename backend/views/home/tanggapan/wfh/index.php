                ...
                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <td class="px-6">
                        <p class="flex items-center justify-start">
                            <a href="<?= Yii::$app->urlManager->createUrl(['/tanggapan/wfh-view', 'id_pengajuan_wfh' => $item['id_pengajuan_wfh']]) ?>" class="relative flex items-center  justify-center p-1.5 bg-[#488aec] rounded-md">
