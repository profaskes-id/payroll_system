...
<div class="container relative mx-auto px-5 min-h-[90dvh]">
                    ...
                    <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
                        ...
                        <div>
                            <h3 class=" text-lg font-medium sm:text-xl flex justify-start items-start space-y-1 flex-col">
                                <a href="#" class="hover:underline"> <?= $value['posisi'] ?> </a>
                                <a href="#" class="hover:underline text-gray-700"><?= $value['perusahaan'] ?> </a>
                            </h3>
    ...
    <div>
        <div class="flex justify-between items-center pt-10 ">
            ...
            <a href="" class="px-2 py-1 lg:px-5 lg:py-2 rounded-md bg-sky-500 text-white font-semibold lg:font-bold">Add New</a>
        </div>
        <div class="grid grid-cols-12 gap-y-5 w-full mt-8">
                    ...
                    <div class="flex items-start gap-4 p-4 sm:p-6 lg:p-8">
                        ...
                        <div>
                            <h3 class=" text-lg font-medium sm:text-xl flex justify-start items-start space-y-1 flex-col">
                                ...
                                ?>
                                <a href="#" class="hover:underline"><?= $jenajngPendidikan['nama_kode'] ?> </a>
                                <a href="#" class="hover:underline text-gray-700"><?= $value['institusi'] ?> </a>
                            </h3>
