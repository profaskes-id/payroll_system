...
/** @var backend\models\SubkategoriExpensesSearch $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="subkategori-expenses-search">
    ...
    <div class="row">
        <div class="col-md-9 col-12">
            <?php $nama_group = \yii\helpers\ArrayHelper::map(SubkategoriExpenses::find()->all(), 'id_subkategori_expenses', 'nama_subkategori');
            echo $form->field($model, 'id_kategori_expenses')->widget(Select2::classname(), [
                'data' => $nama_group,
                'language' => 'id',
                'options' => ['placeholder' => 'Cari Nama Subkategori ...'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ])->label(false);
