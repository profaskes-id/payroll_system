...
<p class="text-center fw-bold" style="padding:0; margin-bottom:5px; font-size: 12px;">
    Periode : <?= date('d F Y', strtotime($model['tanggal_awal'])) ?> s/d <?= date('d F Y', strtotime($model['tanggal_akhir'])) ?>
</p>
