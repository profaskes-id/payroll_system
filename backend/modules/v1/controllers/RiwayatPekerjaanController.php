...
use backend\models\PengalamanKerja as DataPekerjaanModel;
use yii\rest\ActiveController;
use yii\web\NotFoundHttpException;
use yii\web\Response;
use Yii;

class RiwayatPekerjaanController extends ActiveController
{
    public $modelClass = DataPekerjaanModel::class;
