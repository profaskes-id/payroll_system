...
class Karyawan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tanggal_lahir', 'kode_provinsi_domisili', 'kode_kabupaten_kota_domisili', 'kode_kecamatan_domisili', 'desa_lurah_domisili', 'invite_at', 'tanggal_resign', 'wajah', 'nomer_rekening', 'nama_bank'], 'safe'],
            [['alamat_identitas', 'alamat_domisili', 'informasi_lain', 'surat_pengunduran_diri', 'liveness_passed'], 'string'],
            ...
            [['kode_karyawan', 'nomer_rekening'], 'unique'],
