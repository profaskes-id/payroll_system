...
class PembayaranKasbonSearch extends PembayaranKasbon
{
    ...
    {
        return [
            [['id_pembayaran_kasbon', 'id_karyawan', 'id_kasbon', 'bulan', 'tahun', 'status_potongan', 'created_at', 'autodebt'], 'integer'],
            [['jumlah_potong', 'angsuran', 'sisa_kasbon'], 'number'],
            [['tanggal_potong'], 'safe'],
        ];
    }
